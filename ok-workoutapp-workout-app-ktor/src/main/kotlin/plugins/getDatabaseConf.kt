...
fun Application.getDatabaseConfWorkout(type: WktDbType): IWorkoutRepository {
  val dbSettingPath = "${ConfigPaths.repository}.${type.confName}"
  val dbSetting = "postgres" // environment.config.propertyOrNull(dbSettingPath)?.getString()?.lowercase()
